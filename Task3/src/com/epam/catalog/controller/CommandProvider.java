...
import com.epam.catalog.controller.command.impl.SearchBook;
...
public class CommandProvider {
	...
	CommandProvider() {
		repository.put(CommandName.SEARCH_BOOK_BY_NAME, new SearchBook());
		repository.put(CommandName.SEARCH_BOOK_BY_AUTHOR, new SearchBook());
